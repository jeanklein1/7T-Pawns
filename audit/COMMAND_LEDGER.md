...
Last commit touching any scanned file: `eb0fb764cccc0d7cafed8e78efa8da2101463b2d`
(ORRERY_7 U2 — the hold: ceremony off, row-watch alive, state by hand)
...
| 15 | Orb Init | compute | `dispatch_orb_init` | `src/cartridges/the_board/bodies/orbs.hpp:962` | — | — | — |
| 16 | Orb Recolor | compute | `dispatch_orb_recolor` | `src/cartridges/the_board/bodies/orbs.hpp:983` | — | — | — |
| 17 | Orb Copy Prev | compute | `dispatch_orb_copy_prev` | `src/cartridges/the_board/bodies/orbs.hpp:998` | — | — | — |
| 18 | Orb Dynamics | compute | `dispatch_orb_dynamics` | `src/cartridges/the_board/bodies/orbs.hpp:1021` | — | — | — |

:8000/favicon.ico:1  Failed to load resource: the server responded with a status of 404 (File not found)
 ...
 [Device] limits path: core defaults + censused exceptions
 ...
 [Renderer] Render pipelines:  6 ms
 [Renderer] Total pipelines:   12 ms
...
(index):27 [Cartridge] Renderer init:    71 ms
(index):27 [Cartridge] Patch system:     52171 ms
(index):27 [Cartridge] Total init:       52242 ms
(index):27 

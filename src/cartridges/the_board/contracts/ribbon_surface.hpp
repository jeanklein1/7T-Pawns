...
inline constexpr RibbonSurface RIBBON_TABLE = {
    ...
    2.55f,    // board_seconds — REACH_4 had 3.0; EASE_1: 15% faster at Jean's word, the ratio kept
    3.06f,    // land_seconds — REACH_4 had 3.6; EASE_1: 15% faster, still 1.2x the rise
    0.5f,     // wander_soft
